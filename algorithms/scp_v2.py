        ...
        try:
            ...
            for file_name in files:
                ...
                if 'hc1' in parameters.options:
                    constructive_result_1 = randomized_constructive.create_randomized_constructive(subsets,
                                                                                                   pseudo_random)
            ...
            # logging.error("An error occurred: %s", e, exc_info=True)  # exc_info=True logs the traceback
